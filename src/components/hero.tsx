      ...
      <div className="mx-auto max-w-5xl">
        <div className="flex flex-col-reverse items-center gap-12 md:flex-row md:gap-16">
          ...
          >
            ...
            <h2 className="mt-3 text-xl text-muted-foreground sm:text-2xl md:text-3xl">
              {personalInfo.title}
            </h2>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4 md:justify-start">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-accent px-5 py-2.5 text-sm font-medium text-accent-foreground transition-all hover:brightness-110"
              >
                <Download size={16} />
                Download Resume
              </a>
